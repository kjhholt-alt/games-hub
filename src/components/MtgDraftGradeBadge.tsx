 ...
 * (S copper → F slate) applied to the ranker's S–F bands. Never a guessed
 * letter: unrated renders the explicit em-dash plate.
 */
export function MtgDraftGradeBadge({
  ...
  return <MtgTierPlate letter={grade} size={size} />;
}
