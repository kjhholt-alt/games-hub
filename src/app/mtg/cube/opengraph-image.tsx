...
export const alt =
  "MTG Planar Cube Tier List — every card in the Arena Planar Cube pool tiered S-F, basis always shown";
...
// Cube tier grades, same colors as --mtg-tier-* in globals.css.
const GRADES = [
    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Every card in the pool tiered S-F — real Planar Cube data, a
            Powered Cube or cross-set prior, or a transparent heuristic.
          </div>
